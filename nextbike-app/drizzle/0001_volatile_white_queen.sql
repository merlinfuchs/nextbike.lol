...
CREATE TABLE "nextbike"."bikes" (
	...
	"board_computer" bigint NOT NULL,
...
CREATE TABLE "nextbike"."zones" (
	...
	"created_at" timestamp with time zone NOT NULL,
	"updated_at" timestamp with time zone NOT NULL,
	CONSTRAINT "zones_external_id_unique" UNIQUE("external_id")
);
--> statement-breakpoint
...
ALTER TABLE "nextbike"."bike_positions" ADD CONSTRAINT "bike_positions_bike_id_bikes_id_fk" FOREIGN KEY ("bike_id") REFERENCES "nextbike"."bikes"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "nextbike"."bike_positions" ADD CONSTRAINT "bike_positions_place_id_places_id_fk" FOREIGN KEY ("place_id") REFERENCES "nextbike"."places"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "nextbike"."bikes" ADD CONSTRAINT "bikes_network_id_networks_id_fk" FOREIGN KEY ("network_id") REFERENCES "nextbike"."networks"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "nextbike"."places" ADD CONSTRAINT "places_area_id_areas_id_fk" FOREIGN KEY ("area_id") REFERENCES "nextbike"."areas"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "nextbike"."zones" ADD CONSTRAINT "zones_area_id_areas_id_fk" FOREIGN KEY ("area_id") REFERENCES "nextbike"."areas"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "areas_network_id_idx" ON "nextbike"."areas" USING btree ("network_id");--> statement-breakpoint
CREATE INDEX "bike_positions_bike_id_idx" ON "nextbike"."bike_positions" USING btree ("bike_id");--> statement-breakpoint
CREATE INDEX "bike_positions_created_at_idx" ON "nextbike"."bike_positions" USING btree ("created_at");--> statement-breakpoint
CREATE UNIQUE INDEX "bikes_number_network_id_idx" ON "nextbike"."bikes" USING btree ("number","network_id");--> statement-breakpoint
CREATE INDEX "bikes_place_id_idx" ON "nextbike"."bikes" USING btree ("place_id");--> statement-breakpoint
CREATE INDEX "bikes_network_id_idx" ON "nextbike"."bikes" USING btree ("network_id");--> statement-breakpoint
CREATE INDEX "places_bike_idx" ON "nextbike"."places" USING btree ("bike");--> statement-breakpoint
CREATE INDEX "places_area_id_idx" ON "nextbike"."places" USING btree ("area_id");--> statement-breakpoint
CREATE INDEX "zones_geometry_gist" ON "nextbike"."zones" USING gist ("geometry");